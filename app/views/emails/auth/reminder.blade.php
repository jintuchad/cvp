							...
							<tbody>
								...
								<tr>
									<td style="font-size:14px;line-height:20px">
										...
										<p>To reset your password, complete this form: <a href="{{ URL::route('auth-reset-password', array($token)) }}" target="_blank">{{ URL::to('auth-reset-password', array($token)) }}</a>.</p></td></tr>
								<tr>
